...
class TestGoogle(unittest.TestCase):
    def test_esta_en_google_palabra_comun(self):
        texto = "hola"
        self.assertTrue(Google.esta_en_google(texto), "Debería estar en google el texto \"" + texto + "\"")
    ...
    def test_esta_en_google_error_de_tipeo(self):
        texto = "holaa"
        self.assertFalse(Google.esta_en_google(texto), "No debería estar en google el texto \"" + texto + "\"")
