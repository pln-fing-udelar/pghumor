...
if rank == 0:
    print("Soy el padre")
    cantMPI = 2
    for contHijos in range(1, cantMPI):
        comm.send(cantMPI, dest=contHijos, tag=11)
else:
    print("Soy el hijo")
    cantMPI = comm.recv(source=0, tag=11)
...
if __name__ == "__main__":
    ...
    if args.explicar_features:
        ...
        corpus = cargar_tweets(cantMPI,False,rank)
        ...
        if rank==0:
            ...
            for contHijos in range(1, cantMPI):
                ...
                print("entro For"+str(contHijos))

            print("Arranque a cargar tweets")
